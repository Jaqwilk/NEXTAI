...
Status: naprawa zakończona; osobno zatwierdzona JEDNA nowa próba dev (globalnie nr 2).
Wiążący aktualny zakres: research/laboratory/PC-01-DEV2-20260905-V1.json.
Nowa kohorta pomiarowa v2; ta sama recepta, model, dane train/dev i seed 1103,
od inicjalizacji, bez wznowienia checkpointu i bez final. Limity 1200/1800 s.
Awaria v1 i naliczone 1200 s pozostają w historii i wspólnym limicie 7200 s.
Po wyniku lub invalidacji: PC-01-DECISION, bez automatycznej trzeciej próby.
