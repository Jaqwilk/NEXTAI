...
Stara kohorta SuiteSparse ma maintenance, więc nie da się przypadkiem wznowić
jej scoringu. Archiwum pełnego protokołu v2 jest pod docs/archive/.
...
przygotowania i gotowość scoringu. Najbliższe zadanie to PC-01-CONTRACT:
wybrać i zamrozić nowy kontrakt kalibracji uczenia i pomiarów, bez treningu
w cyklu projektowania. Nie uruchamiamy ponownie CAL-20260901-0001.
