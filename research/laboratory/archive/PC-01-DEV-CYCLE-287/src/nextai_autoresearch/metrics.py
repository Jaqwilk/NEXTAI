...
def aggregate_trials(trials: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "program_induction_accuracy": optional_mean("program_induction_accuracy"),
        "length_extrapolation_accuracy": optional_mean("length_extrapolation_accuracy"),
        ...
        "mean_search_ops": optional_mean("mean_search_ops"),
