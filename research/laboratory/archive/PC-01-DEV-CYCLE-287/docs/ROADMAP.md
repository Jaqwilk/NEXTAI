...
## Aktualna ścieżka od 2026-09-04

Obowiązuje `research/LAB_PLAN.md` oraz protokół v3: odtwarzalność -> kontrola
uczenia i pomiarów -> wyjaśnienie WT -> przegląd -> warunkowy prototyp.
Stan G2/infrastructure oznacza reset strategiczny, nie zaliczenie dawnej G2.
Poniższa roadmapa G0–G8 jest zachowaną wizją i historią; stare okno G1,
pierwsza kolejka po G0 i dawny opis aktywnego stanu nie są dzisiejszym zadaniem.
Nie obowiązuje automatyczna brama cross-family dla każdego efektu uczenia.
