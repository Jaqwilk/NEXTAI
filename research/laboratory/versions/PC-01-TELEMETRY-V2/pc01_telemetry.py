"""Prospective PC-01 telemetry V2; the completed V1 source stays immutable."""
...
def read_device_sample(path: Path) -> dict | None:
    ...
    try:
        ...
        # A snapshot path can be momentarily absent while another process
        # publishes a replacement. The supervising parent retains the bounded
        # continuous-unavailability deadline and therefore fails closed if the
        # producer never restores a valid sample.
        return None
